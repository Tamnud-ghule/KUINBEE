        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="mt-4 flex space-x-4">
              {/* LinkedIn Icon */}
              <a href="https://www.linkedin.com/company/kuinbee/" className="text-gray-400 hover:text-white transition-colors">
              ...
              {/* Twitter Icon */}
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=kuinbee.pvt.ltd@gmail.com" className="text-gray-400 hover:text-white transition-colors">
